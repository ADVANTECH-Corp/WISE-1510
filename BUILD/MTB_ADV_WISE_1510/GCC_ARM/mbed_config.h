...
#define CLOCK_SOURCE                                      USE_PLL_HSE_XTAL|USE_PLL_HSI // set by target:MTB_ADV_WISE_1510
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                    0                            // set by target:MTB_ADV_WISE_1510
